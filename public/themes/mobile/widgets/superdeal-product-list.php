        ...
        <div class="col-xs-12 price-superdeal margin-top-20">
          <div class="row">
            ...
            <?php 
                if( $campaignType ):
            ?>
              <div class="col-xs-4"><span class="price-line"><?php echo $product['percent_discount']; ?></span><img alt="<?php echo __('Net Price'); ?> <?php echo $product['title'];?>" src="<?php echo URL::asset('themes/mobile/assets/img/dummy_sale_tag_02.png'); ?>"></div>
            <?php else: ?>
              <div class="col-xs-4"><span class="price-red"><?php echo $product['percent_discount']; ?></span><img alt="<?php echo __('Net Price'); ?> <?php echo $product['title'];?>" src="<?php echo URL::asset('themes/mobile/assets/img/dummy_sale_tag_01.png'); ?>"></div>
            <?php endif; ?>
          </div>
        </div>
      </div>
