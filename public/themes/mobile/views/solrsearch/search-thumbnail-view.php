...
if(!empty($data['data'])){
    ...
    $product_image = '';
    if(!empty($product["image_relate_path_scale"]['l']))
    {
        $product_image = $product["image_relate_path_scale"]['l'];
    }
    else
    {
        $product_image = !empty($product["default_image_scale"]['l'])?$product["default_image_scale"]['l']: '';
    }
