...
<?php $pkey_arr = array();?>
    <?php if ( ! empty($data['products'])) : ?>
        <?php foreach ($data['products'] as $key => $value) : ?>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <div class="product-image">
                                ...
                                ?>
                                <!-- typeidea script -->
                                <a href="<?php echo levelDUrl($slug, $value['pkey']); ?>"  class="ec-product" data-ec-item="category-<?php echo $collection_name; ?>|<?php echo $value['pkey']; ?>|<?php echo (($page-1)*20) + $key+1; ?>" title="<?php echo $value['title']; ?>"><img src="<?php echo ( ! empty($value['image_cover']['normal'])) ? $value['image_cover']['normal'] : ""; ?>"></a></div>
                                <!-- //typeidea script -->
                        </div>
                        <div class="col-xs-8">
                            <div class="row">
                                ...
                                <?php if ( ! empty($value['caption'])) : ?>
                                    <div class="col-xs-12 caption">
                                        <img src="<?php echo Theme::asset()->usePath()->url('img/icon_caption.png'); ?>" alt=""><span><?php echo $value['caption']; ?></span>
                                    </div>
                                <?php endif; ?>
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <?php if ( ! empty($value['special_trueyou_discount'])) : ?>
            ...
            <a href="<?php echo URL::toLang('cate/search-view'); ?>?collectionKey=<?php echo $currentKey; ?>&viewBy=<?php echo $viewBy; ?>&orderBy=<?php echo $orderBy; ?>&order=<?php echo $order; ?>&page=<?php echo $page + 1; ?>&pe=<?php echo $expired_at;?>" class="anchor_href"></a>
        <?php endforeach; ?>
    <?php else : ?>
