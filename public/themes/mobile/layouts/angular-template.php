...
<html lang='<?php echo __("lang_code"); ?>' xml:lang='<?php echo __("lang_code"); ?>' xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" media="all" href="<?php echo Theme::asset()->usePath()->url('css/main.css'); ?>">
    ...
    <body class="itm-background-color">
        <div id="backtotop-arrow">
            <a href="#_top" id="anchorTop">
                <img src="<?php echo Theme::asset()->usePath()->url('img/backtotop.png')?>" alt="Back to Top">
            </a>
        </div>
        <div class="container-fluid itm-container-fluid show-filter" show-filter id="_top">
