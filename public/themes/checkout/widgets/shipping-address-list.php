       ...
       <?php foreach ($shipping_address['data'] as $key => $value) : ?>
        <div data-id="<?php echo $value['customer_addresses_id']; ?>" class="<?php echo ($key == 0) ? 'address-box-active' : 'address-box'; ?>">
            <div class="address-inbox">
                ...
                <p></p>
                <p class="address-detail-container">
                    <?php
                        $addr = strlen($value['address']) > 70 ? mb_substr($value['address'], 0, 70, 'utf-8') . '...' : $value['address'];
                ...
                <div class="ad-dress">
                    <div class="address-delete left"><a data-toggle="modal" data-target="modalConfirm" href="#" class="delete-ship-addr" data-href="<?php echo URL::toLang('ajax/customers/delete-ship-addr?id='.$value['customer_addresses_id']); ?>"><?php echo __('step2-delete-addr'); ?></a></div>
        ...
        <div class="add-addres" id="add-address-btn">
            <div style="padding-top:160px; text-align:center;">
                <h2><a href="javascript:;"><?php echo __('step2-new-ship-addr'); ?></a></h2>
            </div>
