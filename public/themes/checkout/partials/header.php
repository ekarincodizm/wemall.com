...
<div id="header">    
    <div class="sub-content <?php echo (!empty($step)) ? $step : "step"; ?>">
        <div class="logo left">
            <a href="<?php echo URL::toLang("/", array(), false); ?>"><img src="<?php echo Theme::asset()->usePath()->url('images/logo_ph.png?q=102014'); ?>" width="215" /></a>
        </div>
...
<!--                </ul>-->
            ...
            <div class="right top-lang">
                <?php echo __("header-currency"); ?> :&nbsp <span> PHP </span>
                <?php /**
                  <ul class="dropdown-menu" role="menu">
                  <li><a href="#">PHP</a></li>
                  <li><a href="#">USD</a></li>
