        ...
        <div class="in-form">
			...
			?>
				...
				<?php elseif($data['payment_status'] == 'waiting' && $data['payment_channel'] == 'offline'):?>
                    ...
                    <?php if($data['payment_method'] == 7 ):?>
                        <h1><?php echo __("offline-waiting-header-cod"); ?></h1>
                        <br />
                        <div><?php echo __("offline-waiting-content-cod"); ?></div>
                    <?php else:?>
...
//                        if (array_get($data, 'payment_channel') === 'online' && strtolower( $data['payment_method_code'] ) == 'ccw')
                        if (array_get($data, 'payment_channel') === 'online')
                        {
            ...
            <div class="success-thank">
                ...
                <div class="success-box-main">
                    <div class="p-header">
                        <div class="p-logo"><img src="<?php echo Theme::asset()->usePath()->url('images/logo_ph.jpg'); ?>" width="150" height="31" />
                            <p><a href="<?php echo URL::toLang("/"); ?>" alt="www.itruemart.ph" title="www.itruemart.ph">www.itruemart.ph</a></p>
                        </div>
                        <div class="p-box2">
                                ...
                                <div>
                                    ...
                                    <?php foreach($shipment['items'] as $key=>$item): ?>
                                        <div class="p-row">
                                            ...
                                            <p class="extra-deliver-message"><?php echo __("extra-deliver-message"); ?></p>
                ...
                <div class="success-box3">
                    <div>
                        <div class="p-box-right p-title-right">
                            ...
                            <div class="p-title-b">
                                <h2>
                                    <?php if($data['payment_method_code'] == 'ccw' || $data['payment_method_code'] == 'cod' || $data['payment_method_code'] == 'cs'): ?>
                        ...
                        <?php if($data['payment_method_code'] != 'ccw' && $data['payment_method_code'] != 'cod' && $data['payment_method_code'] != 'ccinstm' && $data['payment_method_code'] != 'zero'): ?>
                            ...
                            <?php if(!empty($data['ref2']) && strtolower($data['ref2']) != "null"):?>
                                <div class="p-box-right p-title-right">
...
<!--                        --><?php //if(isset($data["payment_method_code"]) && $data["payment_method_code"] != "zero"): ?>
                        <?php if(isset($data["payment_method"]) && $data["payment_method"] != 10): ?>
                            <div class="p-box-right p-title-right">
                                <p><?php echo __("thankyou-order-payment-channel"); ?></p>
                                <!-- [S] Payment Channel right side -->
                                <?php if($data['payment_method'] == 1): //CCW?>
                                    <div>
                                ...
                                <?php elseif($data['payment_method'] == 4): //ATM?>
                                    <div>
                                ...
                                <?php elseif($data['payment_method'] == 5): //iBank?>
                                    <div>
                                ...
                                <?php elseif($data['payment_method'] == 6): //banktrans?>
                                    <div>
                                        ...
                                        <p><img src="<?php echo Theme::asset()->usePath()->url('images/thank_other.png?random='.random_string('numeric', 4)); ?>" /></p><br />
...
<!--                                        </ul>-->
                                ...
                                <?php elseif($data['payment_method'] == 7): //COD?>
                                    <div>
                                ...
                                <?php elseif($data['payment_method'] == 11): //otcnonbank?>
                                    <div>
                                        <div class="p-title-b-pay "><h2 id="thank_payment_channel"><?php echo __("thankyou-otc-payment-title"); ?></h2></div>
                                        <p><img src="<?php echo Theme::asset()->usePath()->url('images/thank_banktrans.png?random='.random_string('numeric', 4)); ?>"  /></p><br />
                                        <p id="thank_payment_channel_detail"><?php echo __("thankyou-otc-payment-desc"); ?></p>
                                    </div>
                                <?php endif; ?>
...
<?php if (Theme::get('shop_back')): ?>
    <?php echo Theme::get('shop_back');?>
<?php endif; ?>