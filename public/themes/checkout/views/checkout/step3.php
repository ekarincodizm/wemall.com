...
<!--                        <span class="payment-title">Installment (Visa/Master)</span>-->
<!--                    </a>-->
<!--                </h2>-->
<!--            </li>-->
...
<!--                        <span class="payment-title">VISA Card / Master card</span>-->
<!--                    </a>-->
<!--                </h2>-->
<!--            </li>-->
            <li class="ibank active" rel="<?php if( ! empty($cart['data']['all_payment_methods'][$ibank_pkey]['inventory_ids']) ){echo 'available';} ?>" >
                <h2>
                    <a href="#channel-ibanking" data-toggle="tab">
                        <span class="payment-title">Online Banking</span><!--Internet Banking-->
                    </a>
                </h2>
            </li>
            <li class="atm" rel="<?php if( ! empty($cart['data']['all_payment_methods'][$atm_pkey]['inventory_ids']) ){echo 'available';} ?>" >
                <h2>
                    <a href="#channel-atm" data-toggle="tab">
                        <span class="payment-title">Bank Payments</span><!--ATM-->
                    </a>
                </h2>
            </li>
            <li class="cservice" rel="<?php if( ! empty($cart['data']['all_payment_methods'][$cs_pkey]['inventory_ids']) ){echo 'available';} ?>" >
                <h2>
                    <a href="#channel-counterservice" data-toggle="tab">
                        <span class="payment-title">Over the counter</span><!--Counter Service-->
                    </a>
                </h2>
            </li>
            ...
            <li class="bank" rel="<?php if( ! empty($cart['data']['all_payment_methods'][$pay_counter_pkey]['inventory_ids']) ){echo 'available';} ?>" >
                <h2>
                    <a href="#channel-paymentcounter" data-toggle="tab">
                        <span class="payment-title">Other Payment Channels</span><!--Bank Counter-->
                    </a>
                </h2>
            </li>
...
<div class="box-footer">
    <p>
        ...
        <?php echo __('step3-subscribe-news-with'); ?> iTruemart.ph <?php echo __('step3-promotions-and-special-offer'); ?>
    </p>
