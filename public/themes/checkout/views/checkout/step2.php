    ...
    <form id="add-address-frm" method="post" action="<?php echo URL::toLang('checkout/step2'); ?>" data-save-url="<?php echo URL::toLang('ajax/customers/save-ship-addr'); ?>">
        ...
        <div class="in-form">
            ...
            <div>
                ...
                <div class=" form-max ">
                    <input id="telephone" class="input-box" maxlength="11" name="phone_number" type="text" placeholder="<?php echo __("step2-phone-number-placeholder"); ?>"  value="<?php echo $address['customer_tel']; ?>" />
                </div>
            </div>
            ...
            <div>
                ...
                <div class=" form-max">
                    ...
                    if ( !empty($address['customer_province_id'])) {
                        $province_value_id = $address['customer_province_id'];
                    }else{
                        $province_value_id = '';
                    }
                    ?>
                    <select name="province" id="province-control" class="select-new" data-url="<?php echo URL::toLang('ajax/customers/addr'); ?>" data-ref="<?php echo $province_value_id; ?>">
            ...
            <div>
                ...
                <div class=" form-max">
                    <?php
                    if ( ! empty($city) && !empty($address['customer_province_id']) ) {
                        $city_value_id = $address['customer_city_id'];
                    }else{
                        $city_value_id = '';
                    }
                    ?>
                    <select name="district" id="district-control" class="select-new" data-url="<?php echo URL::toLang('ajax/customers/addr'); ?>" data-ref="<?php echo $city_value_id; ?>">
            ...
            <div>
                ...
                <div class=" form-max">
                    <?php
                    if ( ! empty($district) && !empty($address['customer_district_id'])) {
                        $district_value_id = $address['customer_district_id'];
                    }else{
                        $district_value_id = '';
                    }
                    ?>
                    <select name="subdistrict" id="sub-district-control" class="select-new" data-url="<?php echo URL::toLang('ajax/customers/addr'); ?>" data-ref="<?php echo $district_value_id; ?>">
...
<!--                        --><?php //endif; ?>
<!--                    </select>-->
                    <input class="input-box" maxlength="4" id="zip-code-control" name="zip_code" type="text" placeholder="Zip code" value="<?php echo $address['customer_postcode'];?>"/>
                </div>
            </div>
            <div class="clear"></div>
            <div>
                ...
                <div class=" form-max">
                    <textarea rows="4" maxlength="150" name="address" id="address" class="input-box form-address" placeholder="<?php echo __("step2-address-box-placeholder"); ?>"><?php echo $address['customer_address']; ?></textarea>
