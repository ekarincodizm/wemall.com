...
<div class="row address-field">
    <form id="add-address-frm" method="post" action="<?php echo URL::toLang('checkout/step2'); ?>"
        ...
        <div class="col-xs-12">
            ...
            <input id="telephone" maxlength="11" name="phone_number" type="text" class="form-control" placeholder="<?php echo __("step2-phone-number-placeholder"); ?>" value="<?php echo $address['customer_tel']; ?>" />
        </div>
        <div class="col-xs-12">
...
<!--                --><?php //endif; ?>
<!--            </select>-->
            <input id="zip-code-control" class="form-control" name="zip_code" type="text" maxlength="4" placeholder="<?php echo __("step2-select-zipcode"); ?>" value="<?php echo array_get($address, 'customer_postcode'); ?>" />
        </div>
        <div class="col-xs-12">
            <label class="control-label"><?php echo __("step2-address-box"); ?></label>
            <textarea id="address" maxlength="150" name="address" rows="4" class="form-control" placeholder="<?php echo __("step2-address-box-placeholder"); ?>"><?php echo htmlentities($address['customer_address']); ?></textarea>
