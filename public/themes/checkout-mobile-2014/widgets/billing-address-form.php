    ...
    <div class="col-xs-12 address-shipping-section">
        ...
        <div class="row address-tax-field" style="display:<?php echo $displayStyle; ?>;">
            <div class="col-xs-12">
                ...
                <input type="text" class="form-control" maxlength="70" id="bill_name" name="bill_name" placeholder="<?php echo __('step3-type-billing-name-surname'); ?>">
            </div>
            <div class="col-xs-12">
...
<!--                    --><?php //endif; ?>
<!--                </select>-->
                <input type="text" class="form-control" id="bill_postcode" name="bill_postcode" maxlength="4" placeholder="<?php echo __('step2-select-zipcode'); ?>">
            </div>
            <div class="col-xs-12">
                <label class="control-label"><?php echo __('step3-address'); ?></label>
                <textarea maxlength="150" rows="4" name="bill_address" id="bill_address" class="form-control" placeholder="<?php echo __('step3-vill-no'); ?>" autocomplete="off"></textarea>
