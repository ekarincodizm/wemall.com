...
<html lang='<?php echo __("lang_code"); ?>' xml:lang='<?php echo __("lang_code"); ?>' xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="pull_top">
        ...
        <?php /* Content here */ ?>
        <div class="superdeal__container">
...
<!--        <script type="text/javascript" src="<?php //echo Theme::asset()->usePath()->url("js/cart.js"); ?>"></script>-->
...
<!--        -->
<!--        --><?php //if (URL::current() == URL::toLang("")){ ?>
<!--        <div id='laPlaceholder'></div>-->
<!--        <script type="text/javascript">-->
<!--            (function(d,t) {-->
<!--                var script = d.createElement(t); script.id = 'la_x2s6df8d'; script.async = true;-->
<!--                script.src = '//support.itruemart.com/scripts/track.js';-->
<!--                var image = d.createElement('img'); script.async = true;-->
<!--                image.src = '//support.itruemart.com/scripts/pix.gif';-->
<!--                image.style.position = 'absolute';-->
<!--                script.onload = script.onreadystatechange = function() {-->
<!--                    var rs = this.readyState; if (rs && (rs != 'complete') && (rs != 'loaded')) return;-->
<!--                    LiveAgentTracker.createButton('4ae75591', this);-->
<!--                };-->
