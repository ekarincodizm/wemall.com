<div class="content-home sub">
    ...
    <div id="wrapper_content">
        <div id="shop-by-brand">
            ...
            <div id="brand-list">
                <div id="banner-top">
                    <img src="/assets/images/banner-temp.jpg">
                </div>
                        ...
                        <?php foreach ($brands as $key => $subArr) { ?>
                            ...
                            <li>
                                ...
                                <ul class="bl-box">
                                    ...
                                    <li>
                                        <?php
                                        $slug = (isset($brand['slug']) && !empty($brand['slug'])) ? $brand['slug']  : url_title($brand['name']);
                                        ?>
                                        <a href="<?php echo route('brands.products', $slug.'-'.$brand['pkey'].".html") ?>" title="<?php echo $brand['name'] ?>"><?php echo $brand['name'] ?></a>
                                    </li>
                                    <?php } ?>
                                </ul>
                            </li>
