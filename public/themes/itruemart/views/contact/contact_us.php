	...
	<div id="wrapper_content">
		<div id="contactus">
			...
			<div id="contactus-addr">
				...
				<div id="c-addr-info">
					<p id="business-mail"><strong><?php echo __('thankyou-customer-email-lbl');?>:</strong> cs@itruemart.ph</p>
					<p id="business-tel"><strong><?php echo __('step2-phone');?>: </strong>(02)718-9999</p>
					<p id="business-tel">Chat with our Customer Loyalty Team on the iTrueMart Onsite Live Chat widget</p>
					...
					<strong>Customer Loyalty Team</strong>
					<p class="box-info">
