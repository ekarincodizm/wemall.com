                        ...
                        <div id="checkout_detail">
                            ...
                            <div id="checkout_detail2">
                                <div id="detail" class="brd-btm">
                                    ...
                                    <br class="clearfix">
                                    <div id="detail-form">
                                        <label><?php echo __('display_name'); ?> : </label>
                                ...
                                <form action="<?php echo URL::to('member/profile'); ?>" method="post" accept-charset="utf-8" id="address-form">    <div class="col-left addr-list-box">
                                    ...
                                    <div id="addr-detail" class="brd-btm">
                                        <div id="addr-form">
                                            ...
                                            <input type="text" name="name" maxlength="40" value="" id="shipping_fullname"><br>
...
<!--                                            <input type="text" name="address" value="" id="shipping_address" placeholder="--><?php //echo __('address_suggestion'); ?><!--"><br>-->
                                            <textarea name="address" style="margin:0" maxlength="150" id="shipping_address" placeholder="<?php echo __('address_suggestion'); ?>"></textarea><br>
                                            <div style="color: #000000;font-size: 10px;padding: 5px 5px 0;">*Max. 150 characters</div>

                                            <label>
                                                <?php echo __('zip code'); ?> : 
                                            </label>
                                            <input type="text" name="postcode" value="" id="shipping_postcode" maxlength="4" size="50"><br>

                                            <label>
                                                <?php echo __('step3-phone'); ?> : 
                                            </label>
                                            <input type="text" name="phone" value="" id="shipping_phone" maxlength="11" placeholder="<?php echo __('phone_suggestion'); ?>"><br>
                                            <label>
                                                <?php echo __('email'); ?> : 
                                            </label>
...
<div id="profile-dialog" class="reveal-modal">
    <div class="font2 msg-header">Can not add this product to cart.</div>
    <div id="popup_content">
        ...
        <div id="popup_panel">
            <input type="button" class="popup_ok btn cart-installment-button cart-installment-button_cancel" value="Cancel">
        </div>
    </div>
</div>
...
<div id="alert-dialog" class="reveal-modal">
    ...
    <div id="popup_panel">
        <input type="button" class="popup_ok btn btn-success" value="OK">
    </div>
</div>
