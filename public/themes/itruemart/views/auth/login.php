        ...
        <div id="login_regist_wrapper">
            <div class="col-login">
                ...
                <div class="detail_wrapper">
                    ...
                    <?php if ($errors->count()) : ?>
                    <div class="error_msg"><?php echo __($errors->first()); ?></div>
                    <?php endif; ?>

                    <div id="login_error_msg" class="error_msg"></div>
                    <div id="login_remark">
                        <div id="remark">
<!--                            --><?php //echo __('True ID is E-Mail / Mobile Number /True Card that Register from iservice.truelife.com, truelife.com, true-u.com, weloveshopping.com, iTrueMart.com and TrueStore'); ?>
                        </div>
                        <div id="login_pass" class="float-left">
                            <p>
                                <a href="<?php echo Url::Route('forgot'); ?>" name="forgot_password"><?php echo __('forgot password');?></a>
                            </p>
                        </div>
                        <div class="clear"></div>
                    </div>
            ...
            <div class="col-login">
                ...
                <div class="detail_wrapper regist-panel">
                    <p align="center"><?php echo __('create an account');?></p>
                    ...
                    <div align="center">
                        <input type="button" value="<?php echo __('click for buy now');?>" class="btn_guest" onclick="location.href = '<?php echo URL::route('checkout-step1') ?>'">
                    </div>
                </div>
            </div>
