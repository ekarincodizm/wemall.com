	...
	<div id="wrapper_content">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center chekout-info-complete">
                <span class="main-text-info text-red-2"><?php echo __('Your transaction is completed'); ?></span><br class="hidden-xs">
            ...
            <div class="col-xs-12 col-sm-3 col-sm-push-9">
                <div class="text-center menu-right">
                    <div class="box-submit hidden-xs">
                        <input type="button" value="<?php echo __('ช้อปปิ้งต่อ'); ?>" class="btn btn-continue" onclick="javascript: location.href='/';" />
                    </div>
                    <p class="text-left payment-header">
                        <strong><?php echo __('order-detail'); ?></strong>
                    </p>
                    <div class="well total-price total-price-complete">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-sm-7 text-left">
                                เคาร์เตอร์ธนาคาร (Payment Counter)
                                <?php //echo array_get($data, 'data.payment_method_name'); ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-sm-7 text-left">
                                เคาร์เตอร์เซอร์วิส (Counter Service)
                                <?php //echo array_get($data, 'data.payment_method_name'); ?>
                            </div>
                        </div>
                        ...
                        <div class="tag-price text-center">
                            <?php echo __('Total Amount'); ?> <strong><?php echo price_format(array_get($data, 'data.sub_total'),'PHP'); ?></strong>
                        </div>

                    </div>
                    <div class="row text-left status-container hidden-xs">
                        <div class="col-xs-6 col-sm-6 text-left status-text"><?php echo __('Status');?></div>
            ...
            <div class="col-xs-12 col-sm-9 col-sm-pull-3 checkout-detail">
                <div class="col-sm-6">
                    <div class="order-detail">
                        <div class="well well-sm text-center"><?php echo __('order-detail');?></div>
                        <div class="col-sm-12">
                            <ul class="list-unstyled">
                                <li>No. Order : <?php echo array_get($data,'data.order_id'); ?></li>
                                <li><?php echo __('date');?> <?php echo array_get($data, 'data.ordered_date.date'); ?></li>
                    ...
                    <div class="addr-detail">
                        ...
                        <div class="col-sm-12">
                            <ul class="list-unstyled">
                                ...
                                <li><?php echo __('customer_tel'); ?> <?php echo array_get($data,'data.customer_tel');?> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="payment-counter">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p class="hidden-xs">
                                        ดาวน์โหลด และพิมพ์แบบฟอร์มสำหรับชำระเงิน <a href="<?php echo URL::to('checkout/print'); ?>?order_id=<?php echo array_get($data,'data.order_id'); ?>" target="_blank">&gt;&gt; คลิกที่นี่ &lt;&lt;</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
