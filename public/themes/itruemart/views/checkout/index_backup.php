    ...
    <div id="wrapper_content">
        ...
        <div class="row">
            <div class="col-sm-12 text-center chekout-info-complete">
                ...
                <button type="submit" class="btn btn-primary re-checkout" onclick="window.location.href='<?php echo URL::to('/#checkout1'); ?>'"><?php echo __('Go back for shopping');?></button>
            </div>
        </div>
                    ...
                    <div class="text-center menu-right">
                        ...
                        <div class="well total-price">
                            <dl class="dl-horizontal">
                                ...
                                <dd class="text-right"><span style="color:red;"><?php echo price_format(0,null,null,true); ?></span></dd>
                            </dl>
                        ...
                        <div class="text-left verify-itruemart">
                            ...
                            <p>สมาชิก <span class="text-red-1">True Card</span><br>
                                คลิก <a href="http://www.itruemart.com/member/profile">ตรวจสอบสิทธิ์</a>รับส่วนลดเพิ่ม</p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                            ...
                            <div class="col-xs-6 col-sm-2 text-center product-total">
                                <div class="row">
                                    ...
                                    <div class="text-red-1 pr-to-number col-sm-12 col-xs-4">
                                            <?php
                                                if($item['discount'] == 0 || $item['discount'] == null):
                                                    echo '<span class="special-price">' . price_format($item['total_price']) . '</span>';
                                                else:
...
<script>
    var procinces = eval(<?php echo json_encode($provinces); ?>);
