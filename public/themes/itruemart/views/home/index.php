...
<?php echo Theme::widget("mailchimpBox", array())->render(); ?>

<div id="infinite-showroom">
    <?php for($i=1; $i<=$totalShowroom; $i++): ?>
        <div class="showroom-container loading" data-url="<?php echo URL::toLang("ajax/showroom?&limit=1&page=" . $i."&pe=".$page_exp); ?>"></div>
    <?php endfor; ?>
</div>
