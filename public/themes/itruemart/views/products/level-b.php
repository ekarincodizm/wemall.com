        ...
        */?><div class="brand_banner">
                ...
                <div class="prev_lvb" style="display: none;">
                    <a href="<?php echo $pkeyPrev; ?>.html">
                        <img src="http://<?php echo Request::server ("SERVER_NAME"); ?>/assets/itruemart_new/global/images/level_b/levelB_container_01.jpg" width="20" height="290" alt="">
                    </a>
                </div>
                ...
                <div class="next_lvb" style="display: none;">
                    <a href="<?php echo $pkeyNext; ?>.html">
                        <img src="http://<?php echo Request::server ("SERVER_NAME"); ?>/assets/itruemart_new/global/images/level_b/levelB_container_01_2.jpg" width="20" height="290" alt="">
                    </a>
                </div>
        ...
        <div class="left_menu_lvb">
            ...
            <?php if (!empty($brandLists)) { ?>
                ...
                <div class="search_input_box"><input id="key_brand" name="key_brand" class="search_input"></div><div class="search_button_box"><img class="btn_key_brand" src="http://<?php echo Request::server ("SERVER_NAME"); ?>/assets/itruemart_new/global/images/level_b/search_button.jpg" alt="search"></div>
                <div class="space"></div>
                <div class="brandlist">
                    <div>
