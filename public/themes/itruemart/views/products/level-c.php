<div class="content-home sub">
    ...
    <div id="wrapper_content">
        <div class="content">
            ...
            <?php if ($type != 'search'): ?>
                <?php echo Theme::widget('productsBanner', array('metas' => $collectionDetail['metas'], 'collectionDetail' => $collectionDetail))->render(); ?>

                <?php
                    $CollectName = $collectionDetail['name'];
                    if(App::getLocale() == 'en'):
                        $CollectName = isset($collectionDetail['translate']['name']) ? $collectionDetail['translate']['name'] : $collectionDetail['name'] ;
                    endif;
                ?>

                <?php if (!empty($bestSeller)) { ?>
                    <div class="base_seller_head">
                      <h2><?php echo __('Best Seller'); echo " : "; echo __($CollectName); ?></h2>
                    </div>
                <?php } ?>
