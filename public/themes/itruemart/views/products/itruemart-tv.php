            ...
            <?php if ($type != 'search'): ?>
                ...
                <?php if (!empty($bestSeller)) { ?>
                    <div class="base_seller_head">
                      <h2><?php if (!empty($bestSeller)) { echo __('สินค้าขายดี'); echo " : "; } ?><?php echo __('iTruemart TV'); ?></h2>
                    </div>
                <?php } ?>
                ...
                <?php /* =============== itruemart-TV By Brand =============== */ ?>
                <?php if (!empty($brandLists)) { ?>
                    <div class="base_seller_head">
                        <h3><?php echo __('ITRUEMART TV BY BRAND') ?></h3>
                    </div>
                ...
                <div class="brand_banner_img">
                    <!-- Flashsale Banner -->
                    <img src="<?php echo Theme::asset()->url('images/banner/itruemart-tv-banner.jpg'); ?>" alt="BeyerDynamic" style="width:935px;" width="935" height="290">
                </div>

                <div class="base_seller_head">
                    <h2><?php echo __('iTruemart TV'); ?></h2>
                </div>
