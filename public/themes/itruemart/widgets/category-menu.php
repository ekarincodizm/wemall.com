        ...
        <div class="glossymenu">
            ...
            <?php foreach ($collections as $collection) { ?>
                <div style="position: relative; display:block;">
                    ...
                    <a title="<?php echo $collection['name'] ?>" href="<?php echo get_permalink($firstSectionUri, $collection) ?>" class="menuitem2">
                        <?php
                            if(App::getLocale()=='th')
                            {
                                echo array_get($collection,'name');
                            }
                            else
                            {
                                echo array_get($collection,'translate.name', array_get($collection,'name'));
                            }
                        ?>
                    </a>
                </div>
                                                    ...
                                                    <li>
                                                        <a title="<?php echo $children2['name'] ?>" href="<?php echo get_permalink($firstSectionUri, $children2) ?>">
                                                            <?php
                                                                if(App::getLocale()=='th')
                                                                {
                                                                    echo array_get($children2,'name');
                                                                }
                                                                else
                                                                {
                                                                    if(array_get($children2,'translate') != null)
                                                                    {
                                                                        echo array_get($children2,'translate.name');
                                                                    }
                                                                    else
                                                                    {
                                                                        echo array_get($children2,'name');
