...
<!--                    <span class="policy_title">--><?php //echo $policies['shipping']['title']; ?>
                    <span class="policy_title"><?php echo $policies['shipping']['type']?></span>
                </a>
            </li>
            <?php
            $is_active = '';
...
<!--                    <span class="policy_title">--><?php //echo $policies['refund']['title']; ?>
                    <span class="policy_title"><?php echo $policies['refund']['type']?></span>
                </a>
            </li>
            <?php
            $is_active = '';
...
<!--                    <span class="policy_title">--><?php //echo $policies['returnItem']['title']; ?>
                    <span class="policy_title"><?php echo $policies['returnItem']['type']?></span>
                </a>
            </li>
        <?php
        $is_active = '';
