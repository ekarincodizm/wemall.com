...
<div class="order_container">
    ...
    <?php if(Config::get('maintenance.show_btn') == true){ ?>
    ...
    <?php } ?> <a href="javascript:void(0);" style="text-decoration: underline !important;margin-left:10px;" data-toggle="modal" data-target="#howToUseCouponPopup" data-id="promotion-popup-button" class="itruemart-link"><?php echo __("how-to-use-coupon-button"); ?></a>
    <a href="javascript:void(0);" data-toggle="modal" data-target="#howToUseCouponPopup" class="itruemart-link"> <img src="<?php echo Theme::asset()->usePath()->url("images/icn/web-ico-what.png"); ?>" alt="itruemart info" /></a>
    <div class="modal fade bs-example-modal-lg" id="howToUseCouponPopup" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-id="promotion-popup">
        <div class="modal-dialog modal-lg modal-width-682">
            <div class="modal-content">
                <a class="itruemart-coupon-close-button" data-id="itruemart-coupon-close-button" data-dismiss="modal" aria-label="Close">
                    <img src="<?php echo Theme::asset()->usePath()->url("images/icn/bt-close.png"); ?>"  alt="close popup"/>
                </a>
                <img src="<?php echo Theme::asset()->usePath()->url("images/web-popup.jpg"); ?>"  alt="how to use itruemart's coupon"/>
            </div>
        </div>
    </div>
</div>
