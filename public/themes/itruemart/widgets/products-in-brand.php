<?php
    if ( !empty($product['brand']['itruemart_banner_icon']) )
    {
        $brandThumb = $product['brand']['itruemart_banner_icon'];
    }
    else
    {
        $brandThumb = $product['brand']['thumbnail'];
    }
?>
<div class="container-brand-logo">
    ...
    <a href="<?php echo get_permalink('brand', $product['brand']); ?>" title="" onclick="_gaq.push(['_trackEvent', 'Product', 'Brand', 'GG000000000000525']);">
        <img src="<?php echo $brandThumb ?>" alt="" class="brand-logo" style="width:150px;<?php /*height:75px;*/ ?>">
    </a>
    <a href="<?php echo get_permalink('brand', $product['brand']); ?>" class="text-more" title=""><?php echo __('View All Products'); ?></a>
    <?php /*
...
<div class="container-product-brand">
    <ul class="product-brand-bxslider">
        <?php if (isset($inBrandProduct['products']) and count($inBrandProduct['products']) > 0) : ?>
