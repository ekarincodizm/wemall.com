                                    ...
                                    <div class="pic">
                                        ...
                                        <div class="shadow">
                                            <a href="<?php echo get_permalink($firstSectionUri, $brand) ?>" title="<?php echo $brand['name'] ?>">
                                                <img src="<?php echo $brand['thumbnail'] ?>" alt="<?php echo $brand['name'] ?>" width="150"  height="150">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="detail">
                                        ...
                                        <a href="<?php echo get_permalink($firstSectionUri, $brand) ?>" title="<?php echo $brand['name'] ?>">
                                            <span class="font2 strong"> <?php echo (isset($brand['campaign_name'])) ? Str::limit($brand['campaign_name'],18) : $brand['name'];  ?></span><br>
                                            <div class="valid_end">
                                                <strong><span class="font2"><?php echo __('promotion end'); ?></span></strong>
                                            </div>
                                            <div class="ex">
