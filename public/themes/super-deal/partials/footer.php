        ...
        <div class="footer__bar_main-link">
            <div class="main-link_service">
                ...
                <ul class="service_category">
                    ...
                    <li><a href="<?php echo $service['href'];?>" title="<?php echo $service['title'];?>"><?php echo $service['html'];?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
                        ...
                        <li class="channel_name">
                            <?php if(isset($payment['href']) && isset($payment['image'])): ?>
                                <a class="channel_link icn" href="<?php echo $payment['href']? : "#"; ?>">
                                    <img src="<?php echo Theme::asset()->usePath()->url('images/icn/' . $payment['image']); ?>" />
                                </a>
                            <?php endif; ?>
    ...
    <div class="footer__inner_wrapper">
        <div class="footer__bar_bottom">
            <div class="bottom_copyright">
                <p class="title_text">&copy;Copyright 2014 www.itruemart.com- All right reserved</p>
                <span>
