		...
		<!-- Banner Position 15 = Level A Recommended -->
			...
			<?php if ( ! empty($val['group_list'])): ?>
				<?php if ($val['group_list'][0]['banner_total'] != 0): ?>
					...
					<div class="recommend">
						<h3 class="header-text-container"><?php echo __('RECOMMEND');?></h3>
					...
					<div class="new-arrival">
						<h3 class="header-text-container"><?php echo __('NEW ARRIVAL');?></h3>
					...
					<div class="best-seller">
						<h3 class="header-text-container"><?php echo __('BEST SELLER');?></h3>
						<div class="box-banner">
