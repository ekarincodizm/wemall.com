        ...
        <div class="content">
            <div class="brand_banner">
                ...
                <div class="prev_lvb" style="display: none;">
                    <a href="http://www.itruemart.com/brand/@home-777.html">
                ...
                <?php echo Theme::widget('productsBrandStory', array('metas'=>$brandDetail['metas']))->render(); ?>

                <!-- Next -->
                <div class="next_lvb" style="display: none;">
                    <a href="http://www.itruemart.com/brand/a mug design-972.html">
        ...
        <div class="left_menu_lvb">
            ...
            <?php if (!empty($brandLists)) { ?>
                ...
                <div class="search_input_box">
                    <input id="key_brand" name="key_brand" class="search_input"></div><div class="search_button_box"><img class="btn_key_brand" src="http://www.itruemart.com/assets/itruemart_new/global/images/level_b/search_button.jpg" alt="search"></div>
                <div class="space"></div>
                <div class="brandlist">
                    <div>
