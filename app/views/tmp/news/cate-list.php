	...
	<div class="breadcrumbs">
        <div id="link_map">
            <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                <a class="map" itemprop="url" href="<?php echo url(); ?>" title="Shopping Online">
		...
		<div id="main-content">
			...
			<div id="news-category">					
				...
				<div id="news-paging">
					...
					<a id="news-prev" href="<?php echo newsLevelBUrl($category_slug, $category_id); ?>?page=<?php echo $news['data_response']['paging']['page'] - 1; ?>"> <?php echo trans('news.newer'); ?> &gt;&gt;</a>
					<?php endif; ?>
