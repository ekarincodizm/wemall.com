    ...
    <div id="wrapper_content">
        ...
        <div class="row">
            <div class="col-sm-12 text-center chekout-info-complete">
                <span class="main-text-info text-red-2"><?php echo __('No item has been addedd to your cart');?></span><br class="hidden-xs">
                <button type="submit" class="btn btn-primary re-checkout" onclick="window.location.href='<?php echo URL::to('/'); ?>'"><?php echo __('Go back for shopping');?></button>
            </div>
        </div>
                    ...
                    <div class="text-center menu-right">
                        ...
                        <div class="well total-price">
                            <dl class="dl-horizontal">
                                ...
                                <dd class="text-right"><span style="color:red;"><?php echo price_format($checkout['discount']); ?></span></dd>
                        ...
                        <div class="text-left verify-itruemart">
                            <a class="icon-true-card" href="http://<?php echo Request::server ("SERVER_NAME"); ?>/member/profile"></a>
                            
                            <p>สมาชิก <span class="text-red-1">True Card</span><br>
                                คลิก <a href="http://<?php echo Request::server ("SERVER_NAME"); ?>/member/profile">ตรวจสอบสิทธิ์</a>รับส่วนลดเพิ่ม</p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="profile">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control" cols="40" id="shipping_address" name="shipping_address" placeholder="<?php echo __('Village Soi Road');?>" rows="10"></textarea>
                    ...
                    <div class="group_cart product-list product-list-first" style="margin-top: 10px;">
                        <div class="row col-xs-white" style="margin-bottom: 10px;">
                            <div class="col-sm-6 vender-name">
                                <strong><?php echo __('Cart shop');?>: <span class="vender-product-amount"><span class="text-red-1"><?php echo $shipment['vendor_name']; ?></span> (<?php echo $checkout['items_count']; ?> <?php echo __plural('pc', $checkout['items_count']);?>)</span></strong>
                            </div>
