    ...
    <div id="wrapper_content">
        ...
        <div class="row hidden-xs">
            <div class="col-sm-12 text-center chekout-info">
                <strong>ตรวจสอบสินค้าในตะกร้าของท่าน และเลือกวิธีการจัดส่ง แต่ละร้านค้าอาจมีวิธี และค่าใช้จ่ายในการจัดส่งแต่กต่างกันออกไป</strong>
            </div>
        </div><?php /*
                <div class="row hidden-xs">
                ...
                <div class="text-center menu-right">
                    ...
                    <div class="well total-price">
                        <dl class="dl-horizontal">
                            ...
                            <dd class="text-right"><span style="color:red;"><?php echo price_format($checkout['discount'] + $checkout['total_discount']); ?></span></dd>
                    ...
                    <form action="<?php echo URL::toLang('checkout/apply-coupon'); ?>" method="post" id="form-coupon">
                        ...
                        <div class="well text-center voucher">
                            ...
                            <div class="coupon-information text-center" style="color: red;">
                    ...
                    <div id="payment-channel" class="well text-left list-payment-channel">
                        ...
                        <?php if (array_key_exists($key, $checkout['available_payment_methods'])): ?>
                        <div class="payment-channel">
                            <input id="payment-counter" name="payment_channel" value="<?php echo $key; ?>" type="radio"> <label for="payment-counter"><img align="left" class="icon-payment" src="/themes/itruemart/assets/images/icn/channel/icon-payment-counter.png"> <span class="payment-name">เคาร์เตอร์ธนาคาร<br class="hidden-xs">
                        ...
                        <?php if (array_key_exists($key, $checkout['available_payment_methods'])): ?>
                        <div class="payment-channel">
                            <input id="counter-service" name="payment_channel" value="<?php echo $key; ?>" type="radio"> <label for="counter-service"><img align="left" class="icon-payment" src="/themes/itruemart/assets/images/icn/channel/icon-counter-service.png"><span class="payment-name">เคาร์เตอร์เซอร์วิส<br class="hidden-xs">
                ...
                <div class="product-list product-list-first">
                    <div class="row col-xs-white">
                        <div class="col-sm-12 vender-name">
                            <strong>สินค้าของร้าน: <span class="vender-product-amount"><span class="text-red-1"><?php echo $shipment['vendor_name']; ?></span> (<?php echo $shipment['items_count']; ?> ชิ้น)</span></strong>
                        </div>
                    </div>
                        ...
                        <div class="panel col-xs-12 col-sm-7">
                            <div class="panel-body">
                                ...
                                <div class="discount-price-box clearfix">
                                    ...
                                    <div class="col-xs-4 col-sm-4 text-right">
                                        <span class="text-right text-red-1"><?php echo price_format($shipment['total_discount']); ?></span>
                                    </div>
                                </div>
        ...
        <div class="row step-container">
            ...
            <div class="col-xs-6 col-sm-8 text-right">
                <p class="payment-channel-selected"><span>คุณเลือกชำระเงินด้วย<br>
                        <a href="#payment-channel">คลิกเพื่อเปลี่ยนวิธีการชำระเงิน</a></span> <span id="payment-select-show"><img align="left" class="icon-payment" src="http://<?php echo Request::server ("SERVER_NAME"); ?>/assets/itruemart_responsive/global/images/icon-credit-card.jpg"> <span class="payment-name">บัตรเครดิต<br class="hidden-xs">
