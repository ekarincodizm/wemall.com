...
return array(
    'pcms' => array(
        'url'    => 'http://pcms.alpha.itruemart.ph/api',
        'appKey' => '45311375168544',
        'apiPcmsWeb' => "http://webapi.alpha.itruemart.ph/pcms/api",
        'apiPcms' => 'http://pcms.alpha.itruemart.ph/api',
        'webApiKey' => 'gCX5lMv0ZlulP-Oy_6TDMMDBfA_gliX3c5ITy1-ERWM'
    ),

    'itruemart' => array(
        'endpointUrl' => 'http://api.dev.itruemart.ph/rest',
    ...
    'basePrefixUrlWeb' => "www\.alpha\.",
    'basePrefixUrlMobile' => "m.alpha.",

    /** SeletedSiteFilter */
    "mobilePrefixRegex" => "/m\.alpha\./",
    "webPrefixRegex" => "/(www\.alpha\.|alpha\.)/",
    "mobilePrefix" => "m.alpha.",
    "webPrefix" => "www.alpha.",
