...
class WidgetSuperDealMobileBanner extends Widget {
     ...
     * @var string
     */
    public $template = 'super-deal-mobile-banner';
    ...
    public function run()
    {
        ...
        $pcms = App::make('pcms');
        $params = array(
            "position" => Config::get("widget_params.superDealMobileBannerPosition")
        );
