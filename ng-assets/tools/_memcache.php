...
define('ADMIN_USERNAME','9gag'); 	// Admin Username
define('ADMIN_PASSWORD','lol');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

//         array('host' => '192.168.120.252', 'port' => 11212, 'weight' => 100),

$MEMCACHE_SERVERS[] = '192.168.120.252:11212'; // add more as an array
