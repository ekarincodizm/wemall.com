<div class="brand-story">
    ...
    <div class="brand_banner_pic">
        <?php if (!empty($metas['banner-logo'])) : ?>
    ...
    <div style="width:343px;height:290px;float:left;">
        <div class="levelB_container_03">
            ...
            <?php if (!empty($metas['video'])) { ?>
                <iframe width="329" height="173" src="<?php echo str_replace("https://www.youtube.com/watch?v=", "", $metas['video']);?>" frameborder="0"></iframe>
            <?php } ?>
            </div>
        </div>
        <div class="levelB_container_04">
            <div class="brandstory">
                <div class="brandstory_head">BRAND STORY</div>
