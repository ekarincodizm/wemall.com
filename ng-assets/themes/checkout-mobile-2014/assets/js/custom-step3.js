...
function validatePaymentChannel(paymentChannel){
    ...
    }else if(typeof template == "string" && paymentChannel == "installment"){
        //cannot pay installment
        $("#installment-payment-block").hide();
        $("#installment-payment-error").html(template).slideDown();
    }
}
