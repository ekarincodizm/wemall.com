...
<div class="payment-channel">
    ...
    <label for="installment">
        <img src="<?php echo Theme::asset()->usePath()->url("img/ico-installments.png"); ?>" class="ico_payment_channel"/>
        <span class="payment-name">[ผ่อนชำระ] เครดิต<br/><small>Installment (Visa/Master)</small></span>
    </label>
