<div class="payment-channel">
    ...
    <label for="credit-card">
        ...
        <span class="payment-name">[จ่ายเต็ม] บัตรเครดิต/เดบิต<br/><small>VISA Card / Master Card</small></span>
    </label>
        ...
        <div class="add-remark">
            ...
            <div class="form-group select-group">
                ...
                <div class="cybersource">
                    <span>Secured by</span><img src="<?php echo Theme::asset()->usePath()->url("img/cybersource.png");?>" alt="cybersource" />
                </div>
            </div>
        </div>
    </div>
