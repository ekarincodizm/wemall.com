...
<form id="shipping-address-form" method="post"
    ...
    <div class="row address-field">
        ...
        <div class="col-xs-12">
            ...
            <input id="telephone" maxlength="10" name="phone" type="text" class="form-control" placeholder="<?php echo __("step2-phone-number-placeholder"); ?>" value="<?php echo array_get($address, 'phone', $phone); ?>" />
        </div>
        <div class="col-xs-12">
        ...
        <div class="col-xs-12">
            ...
            <textarea maxlength="150" id="address" name="address" rows="4" class="form-control" placeholder="<?php echo __("step2-address-box-placeholder"); ?>"><?php echo array_get($address, 'address'); ?></textarea>
