...
<!--                                <p class="left product-name clr-5">--><?php //echo "bbbbbbsexsex"; //echo __("cart-shipping-method-lbl"); ?><!--</p>-->
<!--                                <div class="no-product-list">-->
<!--                                    <p class="right">-->
<!--                                        <span class="clr-5">-->
<!--                                            <select>-->
...
<!--                        <li>-->
<!--                            <div class="total-list bdr-btm-none">-->
<!--                                <p class="left product-name clr-5">--><?php //echo "bbbbbbdddd"; //echo __("cart-shipping-method-lbl"); ?><!--</p>-->
<!--                                <div class="no-product-list">-->
<!--                                    <p class="right">-->
<!--                                        <span class="clr-5">-->
<!--                                            --><?php
    ...
    <?php if ( ( empty($user['trueyou']) && ACL::isLoggedIn() == true ) || (empty($checkout['cart_trueyou']) && ACL::isLoggedIn() == false) ): ?>
        <div class="total-list trueyou-container">
            <div class="box-discount">
                <p class="control-label-total clr-5"><?php echo __("cart-discount-trueyou"); ?></p>
