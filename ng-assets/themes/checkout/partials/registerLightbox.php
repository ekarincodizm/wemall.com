				...
				<div class="regis-pop">
					...
					<form id="thankyou-register-lightbox" action="<?php echo Url::route('thankyou.savemember'); ?>" method="post">
						...
						<div class="regis-form-control">
							<input class="input-box active-success text-center" maxlength="15" name="email_password" type="password" placeholder="<?php echo __("thankyou-register-lightbox-placeholder"); ?>" >
							<?php if ($errors->count()) : ?>
