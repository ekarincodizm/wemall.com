 ...
 <div class="profile" id="fill-address-form">
     ...
     <input type="hidden" name="hidden_address_id"  id="hidden_address_id" >
        ...
        <div class="col-sm-6">
            ...
            <div class="col-sm-7" style="position: relative;">
                <textarea maxlength="150" name="address" id="address" class="input-box  form-control  form-address" placeholder="<?php echo __("step2-address-box-placeholder"); ?>"><?php echo $address['customer_address']; ?></textarea>
