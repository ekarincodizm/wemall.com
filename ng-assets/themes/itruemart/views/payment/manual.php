    ...
    <div class="breadcrumbs">
        <div id="link_map">
            <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                <a class="map" itemprop="url" href="<?php echo URL::tolang('/'); ?>" title="ช้อปปิ้งออนไลน์">
                    <span itemprop="title">ช้อปปิ้งออนไลน์</span>
                </a>
            </span> &gt; 
            <a class="map">คู่มือการชำระเงิน</a>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-2" id="menu">
                    <ul class="payment-channel list-unstyled">
                        <li class="selected"><a id="menu-atm" href="#atm">ตู้ ATM <br class="hidden-xs">(Bank ATM)<span>&gt;</span></a></li>
                        <li><a id="menu-payment-counter" href="#payment-counter">เคาน์เตอร์ธนาคาร <br class="hidden-xs">(Payment Counter)<span>&gt;</span></a></li>
                        <li><a id="menu-counter-service" href="#counter-service">เคาน์เตอร์เซอร์วิส <br class="hidden-xs">(Counter Service)<span>&gt;</span></a></li>
                        <li><a id="menu-ibanking" href="#ibanking">iBanking <br class="hidden-xs">(Internet Banking)<span>&gt;</span></a></li>
                    </ul>
                </div>
                <div class="col-sm-10">
                    <div class="row">
